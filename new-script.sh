...
mysql -h cne-testdb.cjhtseh9p1qi.eu-west-1.rds.amazonaws.com -P 3306 -u rohithanc -p < Create.sql
mysql -h cne-productiondb.cjhtseh9p1qi.eu-west-1.rds.amazonaws.com -P 3306 -u rohithan -p < Create.sql
